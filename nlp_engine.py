...
async def generate_horoscope(zodiac_sign: str, birth_date: str, city: str, lang: str) -> str:
    ...
    try:
        ...
        # Создаем промт с учетом текущей даты и инструкциями по форматированию
        if lang == 'ru':
            prompt = f"Today is {current_date}. Generate a personalized horoscope for {zodiac_sign} (born {birth_date}) for today. Language: Russian. User is currently in {city}. Do not use Markdown formatting like **bold** or *italics*. Use simple HTML tags like <b> for bold and <i> for italics."
        elif lang == 'en':
            prompt = f"Today is {current_date}. Generate a personalized horoscope for {zodiac_sign} (born {birth_date}) for today. Language: English. User is currently in {city}. Do not use Markdown formatting like **bold** or *italics*. Use simple HTML tags like <b> for bold and <i> for italics."
        elif lang == 'it':
            prompt = f"Today is {current_date}. Generate a personalized horoscope for {zodiac_sign} (born {birth_date}) for today. Language: Italian. User is currently in {city}. Do not use Markdown formatting like **bold** or *italics*. Use simple HTML tags like <b> for bold and <i> for italics."
        else:
            prompt = f"Today is {current_date}. Generate a personalized horoscope for {zodiac_sign} (born {birth_date}) for today. Language: Russian. User is currently in {city}. Do not use Markdown formatting like **bold** or *italics*. Use simple HTML tags like <b> for bold and <i> for italics."
